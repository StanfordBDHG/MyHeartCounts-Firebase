  ...
  private getStageContext(stateOfChange: StageOfChange | null): string {
    ...
    switch (stateOfChange) {
      ...
      case StageOfChange.MAINTENANCE:
        return 'This person is in the maintenance stage of exercise change. This person has maintained their exercise routine for more than six months and wants to sustain that change by avoiding relapses to previous stages.'
      default:
        return ''
    }
  }
